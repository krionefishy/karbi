...
Девять долгоживущих процессов. Каждый — цикл: проснуться, посмотреть, что пора, сделать,
...
flowchart TB
    ...
    subgraph core["wb-core-worker"]
        k1["зеркало WB по всем селлерам:<br/>каталог, остатки, отзывы,<br/>задания и поставки FBS"]
...
| 06:30 | штрафы FBS: детализация фин. отчёта за две недели; повтор через полчаса |
