...
WB не документирует в рассмотренных методах общий максимум складов продавца. Поэтому число 69
...
8. Полный список целевых `officeId` и их распределение по шести региональным группам.
