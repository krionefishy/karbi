...
class PenaltiesWorkerApplication:
    """Отдельный процесс штрафов: раз в сутки перечитывает фин. отчёт подключённых кабинетов."""
...
async def run_worker() -> None:
    application = PenaltiesWorkerApplication()
