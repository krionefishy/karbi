...
ITEMS: tuple[ChecklistItem, ...] = (
    ...
    # Отдельного признака обложки у WB нет: видео карточки и есть её видеообложка.
    ChecklistItem("video_cover", "Видеообложка", "В карточке есть видео — оно и служит видеообложкой."),
